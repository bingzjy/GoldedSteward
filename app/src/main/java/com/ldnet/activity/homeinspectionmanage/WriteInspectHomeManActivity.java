...
public class WriteInspectHomeManActivity extends BaseActionBarActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_start_inspect:
                Intent intent=new Intent(WriteInspectHomeManActivity.this,MainHomeInspectionActivity.class);
