...
public class CreateInspectExceptionActivity extends BaseActionBarActivity {
    ...
    private void showImage(final String path) {
        ...
        Bitmap bitmap = CompressHelper.getDefault(CreateInspectExceptionActivity.this).compressToBitmap(file);
        ...
        new Thread() {
            ...
            public void run() {
                super.run();
                String fileId =new Services().Upload(CreateInspectExceptionActivity.this, path).FileName;
    ...
    public void creationImg(final String imagePath) {
        ImageView iv = new ImageView(CreateInspectExceptionActivity.this);
        ...
        linearParams.setMargins(linearParams.leftMargin, linearParams.topMargin,
                Utility.dip2px(CreateInspectExceptionActivity.this,
