 ...
 */
public class SwipeListViewWrap extends ListView {
    ...
    */
     ...
     */
    public SwipeListViewWrap(Context context, int swipeBackView, int swipeFrontView) {
        super(context);
     ...
     */
    public SwipeListViewWrap(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public SwipeListViewWrap(Context context, AttributeSet attrs, int defStyle) {
